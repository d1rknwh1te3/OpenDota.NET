...
public interface IScenariosEndpoint
{
	...
	Task<IEnumerable<ItemTiming>?> GetItemNamingAsync(string? item = null, int? heroId = null);
	...
	Task<IEnumerable<LaneRoles>?> GetLaneRolesAsync(int? laneRole = null, int? heroId = null);
	...
	Task<IEnumerable<TeamScenario>?> GetMiscTeamScenariosAsync(Scenario? scenario = null);
}